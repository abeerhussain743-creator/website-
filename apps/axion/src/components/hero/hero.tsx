...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="container-x relative z-10 grid items-center gap-10 pb-24 pt-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-6 lg:pt-16">
        <motion.div
        ...
        >
          ...
          <motion.h1
            ...
            className="headline text-[2.6rem] text-text sm:text-5xl md:text-6xl lg:text-[4.35rem]"
          >
          ...
          >
            <MagneticButton href="#cta">Build Your Automation</MagneticButton>
          ...
          <motion.p
            ...
            className="mt-8 text-xs tracking-[0.18em] text-text-dim"
          >
